        ...
        html.Div(
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        html.H3(
                                "CLIMATE FINANCIAL MARKET",
                                style={'color':'lightblue'},
                        ),
                        html.H6(className="title-header", children="CLIMATE FINANCIAL MARKET"),
                        html.P(
                            """
                            Climate Financial Markets will allow the user to visualise trends 
                            related to climate carbon trade. Users may observe bid 
                            and ask differences as well as observe informations such as balance, 
                            equity, and margin as well as free margin, margin level% and open P/L.
                            """,style={'font-size':'120%'}
                        ),
                    ],
                ),
