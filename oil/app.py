                    ...
                    [
                        html.Div(
                            [
                                html.H2(
                                    "ASSET",
                                    style={"margin-bottom": "3px",'color':'darkblue'},
                                ),
                                html.H4(
                                    '''Assets will allow the user to observe different assets that contribute to climate 
                                    change that is present (such as assets related to gas and oil development, injection, etc). Users may set filters to refine 
                                    their searches such as types (whether these assets are active or inactive) and type (whether they are productive or not). 
                                    Users may use the information to identify which assets or infrastructures resources are allocated on.''',
                                    style={"padding-bottom": "25px"},
                                ),                                
                                html.H5(
                                    "New York Oil and Gas Tracker: Production Overview", style={"margin-top": "5px"}
                                ),
                            ]
                        )
                    ],
...
def make_individual_figure(main_graph_hover):
    ...
    figure = dict(data=data, layout=layout_individual,template='plotly_dark')
    return figure
